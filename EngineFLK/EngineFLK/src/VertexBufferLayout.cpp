...
void VertexBufferLayout::Push<float>(int count)
{
	...
	stride += VertexBufferLayoutElement::GetSizeOfType(GL_FLOAT);
}
...
void VertexBufferLayout::Push<unsigned int>(int count)
{
	...
	stride += VertexBufferLayoutElement::GetSizeOfType(GL_UNSIGNED_INT);
}
...
void VertexBufferLayout::Push<unsigned char>(int count)
{
	...
	stride += VertexBufferLayoutElement::GetSizeOfType(GL_UNSIGNED_BYTE);
}